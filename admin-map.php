...
<script>
    ...
    function initMap() {
        var celaya = {lat:20.5280,lng:-100.8113};
...
<div style="display: none" id="form">
    <table class="map1">
        ...
        <tr>
            <td><b>Confirmacion de la  Localizacion :</b></td>
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyAzoXmN8L5jjBCZrKwBCuVg4CnNjwdnC0Y&callback=initMap">
</script>